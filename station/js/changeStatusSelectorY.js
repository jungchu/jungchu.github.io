function changeStatusSelectorY(citySelectorY, statusSelectorY, dataArr, dataLen, getStationInfoY, clearStationInfo){
    clearStationInfo();
    ...
    if (statusSelectorY.value == "不分測站狀態"){
        ...
        }else if (citySelectorY.value == "嘉義縣"){document.getElementById("infoContainerY").innerHTML = "" ;
        for (let i = 0; i < dataLen; i++){ 
